...
int main(){
    ...
    // Test on the BreastCancer dataset. Change the file name to run the program on other data.
    somefilePath =  basePath + "Breastcancer.csv";
    ...
    // Run the algorithms
    // The algorithms are claled in the sequence, Kmeans, Kmeans-d, and Ball Kmeans
